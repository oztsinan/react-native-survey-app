import { useGetTimeoutSurveysQuery } from "@/api/Survey";
...
export const BottomTabSurveyTimeoutList = () => {
  const { colors } = useTheme();
  const { data, isLoading, refetch } = useGetTimeoutSurveysQuery();
